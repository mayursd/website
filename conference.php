<html>
   ...
   <?php
    ...
    $sql1="select reservation from conference";
    ...
    }
    {
             if($fag!=1)
            {
                $sql=$conn->prepare("insert into conference(name,city,mob,email,reservation,type,id) values(?,?,?,?,?,?,?)");
                echo "<img src='logo.png' height='130' width='1350'>";
                echo "<br><br><br><br><br>";
				...
				$nog=$_POST['nog'];
                $sql->bind_param("ssissss",$uname ,$city,$mobno,$email,$dates,$nog,$hey);
                $sql->execute();
            }
    }
?>
