...
$eid=intval($_GET['eid']);
$status="2";
$sql = "UPDATE wedding SET Status=:status WHERE  id=:eid";
...
$sql = "UPDATE wedding SET Status=:status WHERE  id=:aeid";
$query = $dbh->prepare($sql);
$query -> bindParam(':status',$status, PDO::PARAM_STR);
...
<head>
	...
	<title>Meridian Resort |Admin Manage Portal  </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Manage Weddings</h2>
...
{				?>	
										<tr>
											...
											<td><?php echo htmlentities($result->reservation);?></td>
