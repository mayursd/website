...
<head>
	...
	<title>Meridian Resorts | Admin Dashboard</title>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Room Bookings</div>
												</div>
											</div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
												<?php 
$sql1 ="SELECT id from conference ";
...
?>
													...
													<div class="stat-panel-title text-uppercase">Conference Bookings</div>
												</div>
											</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Wedding Bookings</div>
												</div>
											</div>
...
?>												
													...
													<div class="stat-panel-title text-uppercase">Dining Bookings</div>
												</div>
											</div>
